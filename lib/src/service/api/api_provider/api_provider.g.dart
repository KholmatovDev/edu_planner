...
class _ApiProvider implements ApiProvider {
  _ApiProvider(
    ...
    baseUrl ??= 'http://157.173.103.163:3000/api';
  }
  ...
  @override
  Future<AuthResponse> userRegister(RegisterRequest register) async {
  ...
  @override
  Future<UserProfileResponse> setUserProfile(UserProfileRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  @override
  Future<SchedulesResponse> getSchedules() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<SchoolsResponse> getSchools(String regionID) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'region_id': regionID};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SchoolsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SchoolsResponse _value;
    try {
      _value = SchoolsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ClassesResponse> getClasses(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ClassesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ClassesResponse _value;
    try {
      _value = ClassesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
